  ...
  return (
    <div className="navbar-container">
        ...
        <div className="navbar-right-side-container">
           ...
           <div>
        <NavLink to = "/products" >
           <IoBagCheckOutline size="20"  color = "black" /></NavLink>
        </div>
        ...
        <NavLink to = "/cart"> 
         ...
         <span className="length">{state?.cart?.length}</span>  </NavLink>
        </div>
        ...
        <NavLink to = "/profile">
           <BsFillPersonFill size="20 " color = "black" /></NavLink>
        </div>
        :
          <div>
              {/* {console.log("tokjen",token,isLoggedin)} */}
              <NavLink to = "/auth" > 
        <CgProfile  size="20" color = "black" /> </NavLink>
      ...
      {isLoggedin && token &&  <>
         <div>
           <div onClick={logoutHandler} > <NavLink to= "/logout" >
          <IoIosLogOut size="20" color = "black"  /></NavLink></div></div>
